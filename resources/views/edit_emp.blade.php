                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="รหัสพนักงาน" name="emp_id" required value="{{$datas->emp_id}}">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label>ชื่อ</label>
                                <input type="text" class="form-control" placeholder="ชื่อ-สกุล" name="emp_fname" required value="{{$datas->emp_fname}}">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label>สกุล</label>
                                <input type="text" class="form-control" placeholder="ชื่อ-สกุล" name="emp_lname" required value="{{$datas->emp_lname}}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>ที่อยู่</label>
                                <input type="text" class="form-control" placeholder="ที่อยู่" name="emp_add" required value="{{$datas->emp_address}}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>เบอร์โทร</label>
                                <input type="text" class="form-control" placeholder="เบอร์โทร" name="emp_phone" required value="{{$datas->emp_phone}}">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6"> 
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" placeholder="เงินเดือน" name="salary" required value="{{$datas->salary}}">
                            </div>
                        </div> 
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                {{-- <option selected="selected" value="">สายรถ</option> --}}
                                    @foreach ($data2 as $item)
                                        <option value="{{$item->id}}" {{isset($datas->car_id) ? $datas->car_id==$item->id ? 'selected' :'' :''  }}>{{'เลขรถ : '.$item->car_num.' ทะเบียนรถ : '.$item->car_vehicle_reg_num.' สาย : '.$item->lc_num}}</option>
                                    @endforeach
                                  </select>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control"  name="date_off">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>เวลาเข้างาน</label>
                                <input type="time" class="form-control" name="check_in" required value="{{$datas->check_in}}">
                            </div>
                        </div>   
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>เวลาออกงาน</label>
                                <input type="time" class="form-control" name="check_out" required value="{{$datas->check_out}}">
                            </div>
                        </div>  
                    </div>
                </div><!-- /.card-body -->
